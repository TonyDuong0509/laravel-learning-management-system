        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <select name="teacher_id" id=""
                        ...
                        <option value="1" {{ old('teacher_id', $course->teacher_id) == 1 ? 'selected' : '' }}>
                            Francis Duong</option>
                    </select>
                    @error('teacher_id')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="code"
                        class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" placeholder="Mã khoá học..."
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    @error('sale_price', $course->sale_price)
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    @enderror
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <select name="is_document" id=""
                        ...
                        <option value="0" {{ old('is_document', $course->is_document) == 0 ? 'selected' : '' }}>Không
                        </option>
                        <option value="1" {{ old('is_document', $course->is_document) == 1 ? 'selected' : '' }}>Có
                        </option>
                    </select>
                    @error('is_document')
                        <div class="invalid-feedback">
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <select name="status" id=""
                        ...
                        <option value="0" {{ old('status', $course->status) == 0 ? 'selected' : false }}>Chưa ra mắt
                        </option>
                        <option value="1" {{ old('status', $course->status) == 1 ? 'selected' : false }}>Đã ra mắt
                        </option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea name="detail" id="ckeditor" class="form-control">{!! old('detail', $course->detail) !!}</textarea>
                    @error('detail')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
