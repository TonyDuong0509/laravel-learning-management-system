    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('store.course') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="col-md-6"> 
                    <img id="showImage" src="{{ url('upload/no_image.jpg')}}" alt="Course" class="rounded-circle p-1 bg-primary" width="100">  
                </div>
            ...
            <div class="form-group col-md-12">
                ...
                <textarea name="prerequisites" class="form-control" id="input11" placeholder="prerequisites ..." rows="5"></textarea>
            </div>
...
<!--   //////////// End Goal Option /////////////// -->
            ...
            <div class="row mt-3">
                <div class="col-md-4">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" name="bestseller" value="1" id="flexCheckDefault">
            ...
            <div class="col-md-4">
                <div class="col-md-4">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" name="highestrated" value="1" id="flexCheckDefault">
