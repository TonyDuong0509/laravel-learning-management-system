    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <div class="form-group col-md-6">
                ...
                <select name="subcategory_id" class="form-select mb-3" aria-label="Default select example">
                    ...
                    @foreach ($subcategories as $subcategory)
                        <option value="{{ $subcategory->id }}" {{ ($subcategory->id == $course->subcategory_id) ? 'selected' : '' }}>{{ $subcategory->subcategory_name }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group col-md-6">
               ...
               <option selected="" disabled>Select Menu</option> 
                    <option value="Begginer" {{ ($course->label == 'Beginner') ? 'selected' : '' }}>Beginner</option>
            ...
            <div class="form-group col-md-12">
                ...
                <textarea name="prerequisites" class="form-control" id="input11" placeholder="Prerequisites ..." rows="5">{!! $course->prerequisites !!}</textarea>
            </div>
        ...
        <input class="form-check-input" type="checkbox" name="bestseller" value="1" {{ ($course->bestseller === '1') ? 'checked' : '' }} id="flexCheckDefault">
          <label class="form-check-label" for="flexCheckDefault">BestSeller</label>
             ...
             <div class="col-md-4">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="featured" value="1" {{ ($course->featured === '1') ? 'checked' : '' }} id="flexCheckDefault2">
            ...
            <div class="col-md-4">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="highestrated" value="1" {{ ($course->highestrated === '1') ? 'checked' : '' }} id="flexCheckDefault1">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6"> 
                    <img id="showImage" src="{{ asset($course->course_image) }}" alt="{{ $course->course_name }}" class="rounded-circle p-1 bg-primary" width="100">  
                </div>
            </div>
            <br><br>
            <div class="col-md-12">
                        ...
                        <div class="row add_item">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                        ...
                                        <input type="text" name="course_goals[]" id="goals" class="form-control" value="{{ $goal->goal_name }}">
                                </div>
                            </div>
